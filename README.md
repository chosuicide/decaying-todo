...
[直接下载 DECAY v1.0.0 APK](https://github.com/chosuicide/decaying-todo/releases/download/v1.0.0/DECAY-v1.0.0.apk)

在安卓手机上下载后，允许浏览器安装未知来源应用并打开 APK 即可。Android App 与浏览器版分别使用独立的本地存储，任务数据不会自动互通。
